  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
        ...
        <div className="py-28 flex flex-col items-center justify-center">
          ...
          <div className=" text-center px-4 space-y-7">
            <h2 className="md:text-5xl text-4xl font-bold md:leading-snug leading-snug">
              Items Added to The<span className="text-success"> Cart</span>
            </h2>
          </div>
        </div>
      </div>
...

      {
              ...
              <tbody>
                {cart.map((item, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      <button
                        className="btn btn-sm border-none text-red-700 bg-transparent"
        ...
        <Link to="/menu"><button className="btn bg-success text-white mt-3">Back to Menu</button></Link>
      </div>
      }
